...
class PanguPlasimLegacy(Module):
    ...
    def __init__(
        ...
        *,
        ...
        # One varying-boundary channel is the TOA solar forcing, routed into the
        # 3D stream rather than the surface one. It is identified by NAME, so the
        # tuple has to carry every dataset's spelling: `rsdt` (PLASIM),
        # `toa_incident_solar_radiation` (ERA5), `sol_in` (E3SM).
