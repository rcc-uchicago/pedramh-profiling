...
model_24 = onnx.load('pre-trained/pangu_weather_24.onnx')
...
ort_session_24 = ort.InferenceSession('pre-trained/pangu_weather_24.onnx', sess_options=options, providers=[('CUDAExecutionProvider', cuda_provider_options)])
