...
#SBATCH --mem=128G
#SBATCH -o snfo_bench_h100_%x_%j.out
#SBATCH -e snfo_bench_h100_%x_%j.err
...
export SNFO_BENCH_CSV="${SLURM_SUBMIT_DIR}/bench_test_h100_results.csv"

config_file=configs/bench_midway.yaml

echo "=== snfo_bench_test_h100: $(date -Iseconds) ==="
