...
def create_persistence_forecast(
  ...
  # print("max lat diff before fix:", (forecast.latitude - persistence_forecast.latitude).max().values)
  # print("max lon diff before fix:", (forecast.longitude - persistence_forecast.longitude).max().values)

  # logging.info("Coerced persistence_forecast coordinates to match forecast.")

  # # Coerce coordinate values to match exactly (no interpolation)
  # persistence_forecast = persistence_forecast.assign_coords({
  #     "latitude": forecast.latitude,
  #     "longitude": forecast.longitude
  # })

  # print("max lat diff after fix:", (forecast.latitude - persistence_forecast.latitude).max().values)
  # print("max lon diff after fix:", (forecast.longitude - persistence_forecast.longitude).max().values)
...
class _EvaluateAllMetrics(beam.PTransform):
  ...
  def _persistence_like_forecast_chunk(
    ...
    print("persistence_chunk NaNs:", persistence_chunk.isnull().any())
    print("truth_chunk NaNs:", truth_chunk.isnull().any())
