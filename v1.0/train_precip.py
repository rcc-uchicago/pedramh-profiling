from networks.pangu import PanguPrecipModel
...
class Trainer():
    ...
    def __init__(self, params, world_rank):
        ...
        self.train_data_loader, self.train_dataset, self.train_sampler = get_data_loader(
            params, params.train_data_path, dist.is_initialized(), train=True, precip = True)
        self.valid_data_loader, self.valid_dataset = get_data_loader(
            params, params.valid_data_path, dist.is_initialized(), train=False, precip = True)
        ...
        if params.nettype == 'pangu_precip':
