...
python -m torch.distributed.launch --nproc_per_node=$NUM_TASKS_PER_NODE train.py --yaml_config=/eagle/MDClimSim/awikner/PanguWeather-UC/v1.0/config/PANGU_6HR.yaml
